...
linker.cmd: package/cfg/empty_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_pem4fcfg.cmd\)\"$""\"C:/Users/Anthony/OwnCloud/UMSP/SVN/operating-systems/software/MSP/.config/xconfig_empty/\1\""' package/cfg/empty_pem4f.xdl > $@
