...
UART::UART(UARTConfiguration* config, int index)
...
void UART::close() { UART_close(this->handle); }

UART_Handle UART::get_handle() { return this->handle; }

bool UART::perform_write_transaction(const char* write_buffer,
