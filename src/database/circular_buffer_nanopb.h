   ...
   public:
    static void Create(const char *file_name,
        ...
        File file_handle = SdCard::FileOpen(
                        file_name, SdCard::kFileOpenAlwaysMode |
        ...
        // TODO (rskew) update comparison with actual file size for an empty
        // file
    ...
    static NanopbMessageType ReadMessage(const char *file_name) {
        ...
        for (uint8_t i = 0; i < NanopbMessageType_size; i++) {
