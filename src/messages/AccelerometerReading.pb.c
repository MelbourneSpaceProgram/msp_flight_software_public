...
const uint64_t AccelerometerReading_timestamp_millis_unix_epoch_default = 0ull;
...
const pb_field_t AccelerometerReading_fields[5] = {
    ...
    PB_FIELD(  4, FIXED64 , REQUIRED, STATIC  , OTHER, AccelerometerReading, timestamp_millis_unix_epoch, z, &AccelerometerReading_timestamp_millis_unix_epoch_default),
    PB_LAST_FIELD
};
