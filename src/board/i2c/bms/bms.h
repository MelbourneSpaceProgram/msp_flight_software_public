...
class Bms : public I2cDevice {
   public:
    ...
    void WriteToRegister(byte register_location, byte lower_byte,
                         byte upper_byte);
