...
*    (teme) and the pseudo earth fixed system (pef). this apporach is preferred 
...
*    direct      - direction of transfer          eFrom, 'TOO '
*    jdut1       - julian centuries of ut1        days    // FUCK THIS IS SUPPOSED TO BE JULIAN DATES NOT CENTURIES, CHECK gstime function
*
*  outputs       :
