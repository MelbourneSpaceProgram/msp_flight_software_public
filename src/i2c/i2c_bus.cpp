...
I2CBus::I2CBus(I2CConfiguration* config, int index)
...
void I2CBus::close() { I2C_close(this->handle); }

I2C_Handle I2CBus::get_handle() { return this->handle; }

bool I2CBus::perform_transaction(int address, uint8_t* read_buffer,
...
bool I2CBus::perform_write_transaction(int address, uint8_t* write_buffer,
                                       int write_buffer_length) {
    return perform_transaction(address, NULL, 0, write_buffer,
                               write_buffer_length);
}

bool I2CBus::perform_read_transaction(int address, uint8_t* read_buffer,
                                      int read_buffer_length) {
    return perform_transaction(address, read_buffer, read_buffer_length, NULL,
                               0);
}
