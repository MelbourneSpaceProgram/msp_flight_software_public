        ...
        MagnetometerReading &magnetometer_reading)
{
    ...
    if (magno_data_read)
    {
        ...
        magnetometer_reading.x = DecodeMagnoReadingToSI(magno_x_reading_bytes,
                                                        magno_x_adjust);
        magnetometer_reading.y = DecodeMagnoReadingToSI(magno_y_reading_bytes,
                                                        magno_y_adjust);
        magnetometer_reading.z = DecodeMagnoReadingToSI(magno_z_reading_bytes,
                                                        magno_z_adjust);
    }
    else
    {
...
{
    int16_t binary_gyro_reading = ConvertTwoByteReadingToBinaryReading(
            two_byte_gyro_reading);
...
{
    int16_t binary_accel_reading = ConvertTwoByteReadingToBinaryReading(
            two_byte_accel_reading);
...
{
    int16_t binary_temp_reading = ConvertTwoByteReadingToBinaryReading(
            two_byte_temp_reading);
        ...
        etl::array<byte, 2> two_byte_magno_reading, byte magno_adjust_value)
{
    ...
    binary_magno_reading = ConvertTwoByteReadingToBinaryReading(
            two_byte_magno_reading);
        ...
        int16_t magno_reading, byte magno_adjust_value)
{
    ...
    adjusted_magno_reading = scaled_magno_reading
        ...
        GyroFullScaleValue gyro_full_scale_setting)
{
    ...
    this->gyro_full_scale_range =
            MPU9250MotionTracker::kGyroscopeFullScaleRanges[gyro_full_scale_setting];
    this->gyro_sensitivity_scale_factor =
            MPU9250MotionTracker::kGyroscopeSensitivityScaleFactors[gyro_full_scale_setting];
        ...
        AccelFullScaleValue accel_full_scale_setting)
{
    ...
    this->accel_full_scale_range =
            MPU9250MotionTracker::kAccelerometerFullScaleRanges[accel_full_scale_setting];
    this->accel_sensitivity_scale_factor =
            MPU9250MotionTracker::kAccelerometerSensitivityScaleFactors[accel_full_scale_setting];
...
void MPU9250MotionTracker::ConfigureMagnetometer()
{
    ...
    package[1] = (magnetometer_output_bit_setting << 4)
            | magnetometer_operation_mode;
