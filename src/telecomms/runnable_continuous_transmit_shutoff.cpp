...
uint16_t RunnableContinuousTransmitShutoff::transmission_buckets[kNumBuckets] = {0};
...
void RunnableContinuousTransmitShutoff::StartCounter() {
    ...
    while (1) {
      ...
      if(!TransmissionRateUnderThreshold()){
        ...
        Log_info0("Continuous Transmission Detected: Shutting off Lithium Transmission");
      }
