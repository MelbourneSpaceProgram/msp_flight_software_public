...
class RunnablePayloadProcessor : public Runnable {
   public:
    ...
    static const uint8_t kUplinkDataIndex = kUplinkAx25Index + kUplinkAx25Length;
    static const uint8_t kUplinkParityIndex = kUplinkDataIndex + kDataLength;
    static const uint8_t kUplinkLength = kUplinkAx25Length + kDataLength + kParityLength;
    ...
    static const uint8_t kDecodeDataIndex = kDecodePaddingIndex + kDecodePaddingLength;
    static const uint8_t kDecodeParityIndex = kDecodeDataIndex + kDataLength;
    static const uint8_t kDecodeBlockLength = kDecodePaddingLength + kDataLength + kParityLength;
    ...
    static const uint8_t kMspLengthIndex = kMspSignatureIndex + kMspSignatureLength;
    static const uint8_t kMspLengthLength = 1;
    static const uint8_t kMspSequenceNumberIndex = kMspLengthIndex + kMspLengthLength;
    static const uint8_t kMspSequenceNumberLength = 2;
    static const uint8_t kMspHeaderIndex = kMspSignatureIndex;
    static const uint8_t kMspHeaderLength = kMspSignatureLength + kMspLengthLength + kMspSequenceNumberLength;
    ...
    static int16_t GetMspPacketLength(const byte msp_packet[], int16_t max_length);
