...
bool RunnablePayloadProcessor::use_fec = SystemConfiguration::GetInstance()->IsUplinkFecEnabled();
bool RunnablePayloadProcessor::check_hmac = SystemConfiguration::GetInstance()->IsCheckHmacDefault();
bool RunnablePayloadProcessor::check_sequence = SystemConfiguration::GetInstance()->IsCheckSequenceDefault();
