...
#endif
#include <stdio.h>
#include "ina210_tests.h"

/*=======External Functions This Runner Calls=====*/
extern void SetUp(void);
extern void TearDown(void);
extern void TestIna210CurrentRead();
...
/*=======Test Reset Option=====*/
void resetTest_ina210_tests_runner(void);
void resetTest_ina210_tests_runner(void)
{
  TearDown();
  SetUp();
...
/*=======MAIN=====*/
 int ina210_tests_runner(void);
int ina210_tests_runner(void)
{
  MemoryTroubleshooter *mem_test = suite_setup();
  try {
  UnityBegin("src/sensors/i2c_sensors/tests/ina210_tests.cpp");
    RUN_TEST(TestIna210CurrentRead, 13);
