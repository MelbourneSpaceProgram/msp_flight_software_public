...
extern void TestInfraredToAngle(void);
extern void TestCalculateNadirVector(void);
...
/*=======Test Reset Option=====*/
void resetTest_earth_sensor_tests_runner(void);
void resetTest_earth_sensor_tests_runner(void)
{
  TearDown();
  SetUp();
...
/*=======MAIN=====*/
 int earth_sensor_tests_runner(void);
int earth_sensor_tests_runner(void)
{
  MemoryTroubleshooter *mem_test = suite_setup();
  try {
  UnityBegin("src/sensors/tests/earth_sensor_tests.cpp");
    RUN_TEST(TestInfraredToAngle, 7);
    RUN_TEST(TestCalculateNadirVector, 24);
