...
#endif
#include <stdio.h>
#include "ina211_tests.h"

/*=======External Functions This Runner Calls=====*/
extern void SetUp(void);
extern void TearDown(void);
extern void TestIna211CurrentRead();
...
/*=======Test Reset Option=====*/
void resetTest_ina211_tests_runner(void);
void resetTest_ina211_tests_runner(void)
{
  TearDown();
  SetUp();
...
/*=======MAIN=====*/
 int ina211_tests_runner(void);
int ina211_tests_runner(void)
{
  MemoryTroubleshooter *mem_test = suite_setup();
  try {
  UnityBegin("src/sensors/i2c_sensors/tests/ina211_tests.cpp");
    RUN_TEST(TestIna211CurrentRead, 13);
