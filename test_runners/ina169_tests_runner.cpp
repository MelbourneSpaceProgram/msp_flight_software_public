...
#endif
#include <stdio.h>
#include "ina169_tests.h"

/*=======External Functions This Runner Calls=====*/
extern void SetUp(void);
extern void TearDown(void);
extern void TestIna169CurrentRead();
...
/*=======Test Reset Option=====*/
void resetTest_ina169_tests_runner(void);
void resetTest_ina169_tests_runner(void)
{
  TearDown();
  SetUp();
...
/*=======MAIN=====*/
 int ina169_tests_runner(void);
int ina169_tests_runner(void)
{
  MemoryTroubleshooter *mem_test = suite_setup();
  try {
  UnityBegin("src/sensors/i2c_sensors/tests/ina169_tests.cpp");
    RUN_TEST(TestIna169CurrentRead, 13);
