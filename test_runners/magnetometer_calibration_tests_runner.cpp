...
#endif
#include <stdio.h>
#include "magnetometer_calibration_tests.h"
...
/*=======Test Reset Option=====*/
void resetTest_magnetometer_calibration_tests_runner(void);
void resetTest_magnetometer_calibration_tests_runner(void)
{
  TearDown();
  SetUp();
...
int magnetometer_calibration_tests_runner(void)
{
  ...
  UnityBegin("src/sensors/tests/magnetometer_calibration_tests.cpp");
    RUN_TEST(TestComputeS, 67);
    RUN_TEST(TestMagnetometerCalibration, 82);
